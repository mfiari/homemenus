<header class="clearfix">
	...
	<h4><?php echo $request->client->prenom; ?> <?php echo $request->client->nom; ?> (commande #<?php echo $request->id_commande; ?>)</h4>
			...
			<div class="chat-message clearfix">
				<div class="chat-message-content clearfix">
					...
					<?php if ($message->sender == "CLIENT") : ?>
						<h5><?php echo $request->client->prenom; ?> <?php echo $request->client->nom; ?></h5>
					<?php else : ?>
						<h5>Moi</h5>
					<?php endif; ?>
