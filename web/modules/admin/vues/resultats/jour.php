		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					...
					<li role="presentation"><a href="?action=stats_history">Par restaurant</a></li>
					<li role="presentation"><a href="?action=stats_history">Par livreur</a></li>
					<li role="presentation"><a href="?action=stats_history">Par client</a></li>
					<li role="presentation"><a href="?action=stats_history">Par ville</a></li>
					<li role="presentation"><a href="?action=stats_history">Par jour</a></li>
				</ul>
				<div class="col-md-10  col-md-offset-1">
					<div class="row">
