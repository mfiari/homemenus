		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a href="?action=livreur_history">Par livreur</a></li>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<?php foreach ($request->livreurs as $livreur) : ?>
									...
									<?php 
										$totalCommande += $livreur['total_commande'];
										$partRestaurant += $livreur['part_restaurant'];
										$partLivreur += $livreur['part_livreur'];
										$totalPrix += $livreur['total_prix'];
									?>
								<?php endforeach; ?>
							</tbody>
							<tfoot>
