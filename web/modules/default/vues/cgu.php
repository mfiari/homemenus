<div class="row">
	<div class="col-md-10  col-md-offset-1">
		<h2>CONDITIONS GÉNÉRALES D'UTILISATION DU SITE cservichezvous.fr</h2>
		...
		<p>Le site <span id="span_id_nom_site">cservichezvous.fr</span> est édité par :</p>


		<p><span id="span_id_nom_editeur">SASU XXX</span>, dont le siège siège social est situé à l'adresse suivante : <span id="span_id_adresse_siege_social_editeur">2 rue des aubépines 78440 Issou</span>, et immatriculée au registre suivant : <span id="span_id_immatriculation_editeur">XXXX</span>.</p>
		<p>Téléphone : <span id="span_id_n_de_telephone_de_la_societe">XXXX</span>/ Adresse e-mail : <span id="span_id_adresse_mail_editeur">contact@cservichezvous.fr</span>.</p>
		...
		<p><br>Le site <span id="span_id_nom_site">cservichezvous.fr</span> est hébergé par :</p>
		<p><span id="span_id_denomination_sociale_de_l_hebergeur">PlanetHoster</span>, dont le siège est situé <span id="span_id_siege_social_de_l_hebergeur">4416 Louis-B.-Mayer Laval, Québec Canada H7P 0G1</span></p>
		...
		<p>Le site <span id="span_id_nom_site">cservichezvous.fr</span> a pour objet :</p>
		<p><span id="span_id_description_personnalisee_du_site">Livraison de plats à domicile</span></p>
		<p><strong><br>ARTICLE 3. CONTACT</strong></p>
		<p>Pour toute question ou demande d'information concernant le site, ou tout signalement de contenu ou d'activités illicites, l'utilisateur peut contacter l'éditeur à l'adresse e-mail suivante: <span id="span_id_adresse_e_mail_de_contact_pour_le_dp">contact@cservichezvous.fr</span> ou adresser un courrier recommandé avec accusé de réception à : <span id="span_id_nom_editeur">SASU XXX</span> - <span id="span_id_adresse_siege_social_editeur">2 rue des aubépines 78440 Issou</span></p>
		...
		<p>La connexion et la navigation sur le site <span id="span_id_nom_site">cservichezvous.fr</span> valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.</p>
		...
		<p>L'inscription et l'accès aux services du site sont réservés exclusivement aux personnes physiques  capables juridiquement, ayant rempli et validé le formulaire d'inscription disponible en ligne sur le site <span id="span_id_nom_site">cservichezvous.fr</span>, ainsi que les présentes Conditions Générales d'Utilisation.</p>
		...
		<p>Toute communication réalisée par <span id="span_id_nom_site">cservichezvous.fr</span> et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l'utilisateur. Ce dernier s'engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.</p>
		...
		<p>L'identifiant est définitif, en revanche le mot de passe est modifiable en ligne par l'utilisateur dans son Espace personnel. Le mot de passe est personnel et confidentiel, l'utilisateur s'engage ainsi à ne pas le communiquer à des tiers.</p>
		<p><span id="span_id_nom_site">cservichezvous.fr</span> se réserve en tout état de cause la possibilité de refuser une demande d'inscription aux services en cas de non-respect par l'Utilisateur des dispositions des présentes Conditions Générales d'Utilisation.</p>
		<p>7.2 DÉSINSCRIPTION</p>
		<p>L'utilisateur régulièrement inscrit pourra à tout moment demander sa désinscription en se rendant sur la page dédiée dans son Espace personnel. Toute désinscription du site sera effective après que l'utilisateur ait rempli le formulaire prévu à cet effet, dans le délai suivant : <span id="span_id_delai_desinscription_nombre">2 jours</span>.</p>
		...
		<p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels <span id="span_id_nom_site">cservichezvous.fr</span> n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.</p>
		...
		<p>Enfin, <span id="span_id_nom_site">cservichezvous.fr</span> se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale.</p>
		<p><br><strong>ARTICLE 10. COLLECTE DE DONNÉES</strong></p>
		<p>Le site est déclaré à la Commission Nationale Informatique et Libertés (CNIL) sous le numéro <span id="span_id_numero_de_declaration_a_la_cnil" class="encours">XXXX</span> </p>
		...
		<p>Pour faire usage de l'un des droits précités, l'utilisateur doit s'adresser à l'éditeur en le contactant par e-mail à l'adresse suivante : <span id="span_id_adresse_e_mail_de_contact_pour_le_dp">contact@cservichezvous.fr</span>, ou par courrier recommandé adressé au siège social de l'éditeur en précisant ses nom, prénom(s), adresse et adresse(s) e-mail.</p>
		...
		<p style="text-align: center;"><em><br>Le site <span id="span_id_nom_site">cservichezvous.fr</span> vous souhaite une excellente navigation !</em></p>
	</div>
</div>