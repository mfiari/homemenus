	...
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="row">
			...
			<div>
				...
				<p>Rendez-vous sur la page de <a href="?action=restaurants_partenaire">nos restaurants partenaire</a> afin de voir tous les restaurants avec lesquelles nous travaillons</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<p>Vous souhaitez créer un compte entreprise pour vos salarié. Envoyez-nous votre demande via notre <a href="?controler=contact&action=entreprise">page de contact pour les entreprises</a>.</p>
