...
<div id="restaurant">
	...
	<?php foreach ($restaurant->categories as $categorie) : ?>
		...
		<div class="col-md-4">
			<div class="col-md-10 col-md-offset-1 item">
				<div class="title"><a href="?controler=restaurant&action=categories&id_restaurant=<?php echo $request->restaurant->id; ?>&id_categorie=<?php echo $categorie->id; ?>"><?php echo utf8_encode($categorie->nom); ?></a></div>
				<div class="vignette"><a href="?controler=restaurant&action=categories&id_restaurant=<?php echo $request->restaurant->id; ?>&id_categorie=<?php echo $categorie->id; ?>"><img src="<?php echo $categorie->logo; ?>"></a></div>
			</div>
		</div>
		<?php if ($nbItem %3 == 2) : ?>
			</div>
	...
	<?php endif; ?>
		<div class="col-md-4">
			<div class="col-md-10 col-md-offset-1 item">
				<div class="title"><a href="?controler=restaurant&action=menu&id=<?php echo $request->restaurant->id; ?>">Menus</a></div>
				<div class="vignette"><a href="?controler=restaurant&action=menu&id=<?php echo $request->restaurant->id; ?>"><img src="<?php echo $request->restaurant->getMenuImg(); ?>"></a></div>
			</div>
		</div>
	</div>
