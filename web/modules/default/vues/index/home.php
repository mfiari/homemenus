<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img src="res/img/slider1.jpg" alt="HoMe Menus - Livraison">
			<div class="carousel-caption">
				<h3>Livraison Gratuite</h3>
				<p>Livraison gratuite dimanche 10 juillet a partir de 19 heures.</p>
			</div>
		</div>
		<div class="item">
			<img src="res/img/slider1.jpg" alt="HoMe Menus - Livraison">
			<div class="carousel-caption">
				<h3>Précommande disponible</h3>
				<p>Nous ne livrons qu’à partir de 19h mais vous pouvez précommander dès maintenant.</p>
			</div>
		</div>
...
<div class="col-md-12 even">
	...
	<div class="row">
		<div class="col-md-9 col-sm-9 col-xs-9">
			...
			<p>Vous avez des questions sur le site et son fonctionnement. Rendez-vous sur la page <a href="?action=faq">FAQ</a> pour avoir tous les renseignements.</p>
		</div>
