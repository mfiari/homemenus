<div class="row">
	<div class="col-md-10  col-md-offset-1">
		...
		<strong>Webmaster</strong> : Fiari Mike – informatique@homemenus.fr<br />
		<strong>Hébergeur</strong> : planethoster – 4416 Louis-B.-Mayer Laval, Québec Canada H7P 0G1<br />
		Crédits : les mentions légales ont été générées et offertes par Subdelirium 
		<a target="_blank" href="http://www.subdelirium.com/agence-web/agence-web-bordeaux/" alt="agence web bordeaux">agence web Bordeaux</a></p>

		<h3>2. Conditions générales d’utilisation du site et des services proposés.</h3>
		<p>L’utilisation du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		les utilisateurs du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		sont donc invités à les consulter de manière régulière.</p>
		<p>Ce site est normalement accessible à tout moment aux utilisateurs. 
		Une interruption pour raison de maintenance technique peut être toutefois décidée par HoMe Menus, 
		qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention.</p>
		<p>Le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> est mis à jour régulièrement par Ledoux Alexis. 
		...
		<p>Le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> a pour objet de fournir une information concernant 
		...
		Par ailleurs, les renseignements figurant sur le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		<p>HoMe Menus est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, 
		...
		quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : HoMe Menus.</p>
		<p>Toute exploitation non autorisée du site ou de l’un quelconque des éléments qu’il contient sera considérée comme constitutive d’une contrefaçon 
		et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>
		
		<h3>6. Limitations de responsabilité.</h3>
		<p>HoMe Menus ne pourra être tenue responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site homemenus.fr, 
		...
		<p>HoMe Menus ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) 
		consécutifs à l’utilisation du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a>.</p>
		...
		HoMe Menus se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé dans cet espace qui contreviendrait à la législation 
		applicable en France, en particulier aux dispositions relatives à la protection des données. 
		Le cas échéant, HoMe Menus se réserve également la possibilité de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, 
		...
		<p>A l'occasion de l'utilisation du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a>, 
		peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site 
		<a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a>, le fournisseur d'accès de l'utilisateur, 
		l'adresse de protocole Internet (IP) de l'utilisateur.</p>
		<p> En tout état de cause HoMe Menus ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains 
		services proposés par le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a>. 
		...
		Il est alors précisé à l'utilisateur du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		<p>Aucune information personnelle de l'utilisateur du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		<p>Le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> contient un certain nombre de liens hypertextes 
		vers d’autres sites, mis en place avec l’autorisation de HoMe Menus. 
		Cependant, HoMe Menus n’a pas la possibilité de vérifier le contenu des sites ainsi visités, 
		et n’assumera en conséquence aucune responsabilité de ce fait.</p>
		<p>La navigation sur le site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		<p>Sous Chrome : Cliquez en haut à droite du navigateur sur le pictogramme de menu (symbolisé par trois lignes horizontales). 
		...
		<p>Tout litige en relation avec l’utilisation du site <a href="http://homemenus.fr/" title="HoMe Menus - homemenus.fr">homemenus.fr</a> 
		...
		l'identification des personnes physiques auxquelles elles s'appliquent » (article 4 de la loi n° 78-17 du 6 janvier 1978).</p>
	</div>
</div>