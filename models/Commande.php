...
class Model_Commande extends Model_Template {
	...
	public function load () {
		...
		SELECT 
			...
			ul.latitude AS lat_livreur, ul.longitude AS lon_livreur, ul.is_ready AS livreur_ready, com.date_commande, com.heure_souhaite, 
			com.minute_souhaite, com.date_validation_restaurant, com.date_fin_preparation_restaurant, com.date_recuperation_livreur, com.etape, com.prix 
		FROM commande com
